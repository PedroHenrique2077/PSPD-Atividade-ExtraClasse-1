...
// Mensagem de solicitação para obter informações do produto
type ProductRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"` // Identificador único do produto
...
// Mensagem de resposta com as informações do produto
type ProductResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`         // Identificador do produto
	Price         float64                `protobuf:"fixed64,2,opt,name=price,proto3" json:"price,omitempty"` // Preço do produto
	Stock         int32                  `protobuf:"varint,3,opt,name=stock,proto3" json:"stock,omitempty"`  // Quantidade em estoque
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_product_proto_rawDesc = "" +
	...
	"\x05stock\x18\x03 \x01(\x05R\x05stock2Q\n" +
	"\x0eProductService\x12?\n" +
	"\n" +
	"GetProduct\x12\x17.product.ProductRequest\x1a\x18.product.ProductResponseB\x12Z\x10/proto;productpbb\x06proto3"
